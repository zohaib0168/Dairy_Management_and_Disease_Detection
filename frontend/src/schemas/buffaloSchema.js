...
const buffaloSchema = yup.object().shape({
    buffalo_code: yup.number().max(30).required("Code is required"),
    ...
    with_calf: yup.string().notRequired(),
